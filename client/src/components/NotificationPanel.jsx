...
//     ],
//     text: "New task has been assigned to you and 2 others. The task priority is set a normal priority, so check and act accordingly. The task date is Thu Feb 29 2025. Thank you!!!",
//     task: null,
//     notiType: "alert",
//     isRead: [],
//     createdAt: "2025-02-09T05:45:23.353Z",
//     updatedAt: "2025-02-09T05:45:23.353Z",
//     __v: 0,
//   },
//   {
...
//     ],
//     text: "New task has been assigned to you and 2 others. The task priority is set a high priority, so check and act accordingly. The task date is Fri Feb 09 2025. Thank you!!!",
//     task: {
...
const NotificationPanel = () => {
  ...
  const viewHandler = (notification) => {
    if (notification.task) {
      ...
      markAsRead({ type: "single", id: notification._id });
    }
    setOpen(false);
  };
